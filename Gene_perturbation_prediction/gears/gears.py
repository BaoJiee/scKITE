...
class GEARS:
    ...
    def tunable_parameters(self):
        ...
        return {
            ...
            'adapter_name': 'adapter name: native_gears, random, or stage2',
            'gene_embedding_mode': 'gene embedding mode: native, scfm_static, or scfm_contextual',
            'pert_embedding_mode': 'perturbation embedding mode: native or scfm_init',
    ...
    def model_initialize(self, hidden_size = 64,
        ...
        if adapter_name == "stage2" or gene_embedding_mode in ["scfm_static", "scfm_contextual"] or pert_embedding_mode == "scfm_init":  # 只有需要 stage2 adapter 时补充参数。 #
        ...
        need_adapter = (
            gene_embedding_mode in ['scfm_static', 'scfm_contextual']
            or pert_embedding_mode == 'scfm_init'
        ...
        if pert_embedding_mode == 'scfm_init':
            if adapter is None:
                raise ValueError("pert_embedding_mode='scfm_init' requires an adapter.")
