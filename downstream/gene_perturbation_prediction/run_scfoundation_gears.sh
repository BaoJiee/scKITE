...
: "${SCFOUNDATION_SOURCE_DIR:?Set SCFOUNDATION_SOURCE_DIR to the scFoundation repository path.}"
: "${SCFOUNDATION_CKPT:?Set SCFOUNDATION_CKPT to the scFoundation checkpoint path.}"
CANONICAL_GENE_PATH="${SCFOUNDATION_SOURCE_DIR}/model/OS_scRNA_gene_index.19264.tsv"
HGNC_MAPPING_PATH="${HGNC_MAPPING_PATH:-${REPO_ROOT}/data/gene_perturbation_prediction/gene_mapping/hgnc_complete_set.txt}"
