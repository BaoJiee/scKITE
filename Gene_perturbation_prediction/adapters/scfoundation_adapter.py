...
class ScFoundationAdapter(BaseSCFMAdapter):
    ...
    def _pack_encoder_input(self, full_input):
        ...
        # Match the official getEncoerDecoderData/gatherData contract: retain
        # every positive token, in original gene order, and pad each cell to
        # the largest non-zero-token count in this mini-batch.
